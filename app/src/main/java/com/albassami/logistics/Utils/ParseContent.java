    ...
    public RequestDetail parseRequestStatus(String response) {
        ...
        try {
            ...
            if (jsonObject.getString("success").equals("true")) {
                JSONObject data = jsonObject.optJSONObject(Const.Params.DATA);
                requestDetail.setCurrnecy_unit(data.optString("currency"));
                requestDetail.setCancellationFee(data.optString("cancellation_fine"));
                ...
                if (jarray.length() > 0) {
                    ...
                    if (driverdata != null) {
                        ...
                        requestDetail.setNo_tolls(data.optString("number_tolls"));
                    ...
                    JSONArray invoicejarray = data.getJSONArray("invoice");
