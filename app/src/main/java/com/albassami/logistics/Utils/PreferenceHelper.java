...
public class PreferenceHelper {
    ...
    private static final String IS_ONGOING = "is_ongoing" ;
    ...
    public void putIs_Ongoing(boolean isOnGoing) {
        Editor edit = app_prefs.edit();
        edit.putBoolean(IS_ONGOING, isOnGoing);
        edit.commit();
    }
    public boolean getIs_OnGoing() {
        return app_prefs.getBoolean(IS_ONGOING, true);
    }

    public void putdefalutPayment_Mode(String name) {
        Editor edit = app_prefs.edit();
        edit.putString(PAYMENT_MODE, name);
        edit.commit();
    }

    public String getdefalutPayment_Mode() {
        return app_prefs.getString(PAYMENT_MODE, "");
    }

    public void putModel(Object request){
        Editor edit = app_prefs.edit();
        Gson gson = new Gson();
    ...
    public  String getModel(){
        Gson gson = new Gson();
        String json = app_prefs.getString(REQUEST, "");
//        RequestDetail obj = gson.fromJson(json, RequestDetail.class);
        return app_prefs.getString(REQUEST, json);
    }
