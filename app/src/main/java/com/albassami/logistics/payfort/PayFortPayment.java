...
import com.albassami.logistics.network.ApiManager.RestClient_for_strings;
...
public class PayFortPayment {
    ...
    //Statics
    private  static String MERCHANT_IDENTIFIER = "";
    private  static String ACCESS_CODE = "";
    private  static String SHA_TYPE = "SHA-256";
    private  static String SHA_REQUEST_PHRASE = ".BGp9G";
    ...
    private void getpayfortdate() {

        apiServices = RestClient_for_strings.getApiService();

        Call<String> data = apiServices.getfortdata();
        data.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if(jsonObject!=null){
                        ...
                        if(data!=null){
                            MERCHANT_IDENTIFIER=data.optString("merchant_identifier");
                          ACCESS_CODE=data.optString("access_code");
                        //    SHA_TYPE=data.optString("sha_type");
                           SHA_REQUEST_PHRASE=data.optString("request_phrase");
                           SHA_RESPONSE_PHRASE=data.optString("response_phrase");
            ...
            public void onFailure(Call<String> call, Throwable t) {
                UiUtils.hideLoadingDialog();
                Toast.makeText(context, "you cant pay for now please try again later", Toast.LENGTH_SHORT).show();
