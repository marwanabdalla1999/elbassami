package com.albassami.logistics.Service;
...
import com.albassami.logistics.NewUtilsAndPref.AppConstants;
...
public class LocationService extends Service implements
    ...
    public static Intent getLocationBroadcastIntent(Double lat, Double lng, String cityName, String streetName) {
        ...
        intent.putExtra(Params.LOCATION, streetName + "," + cityName);
        intent.putExtra(Const.Params.LATITUDE, lat);
    ...
    private void sendMessageToUI(Double lat, Double lng) {
        ...
        Intent intent = getLocationBroadcastIntent(lat, lng, cityName, streetName);
